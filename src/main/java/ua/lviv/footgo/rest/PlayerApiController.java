...
public class PlayerApiController {
    ...
    public Player update(@PathVariable Long id, @RequestParam String firstName, String lastName, int number, String phone, String email,
                         @RequestParam String imageUrl, @RequestBody(required = false) String descriptionText) {
        ...
        player.setDescriptionText(descriptionText);
